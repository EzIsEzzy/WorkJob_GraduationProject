@include('layouts.header')
    ...
    <div class="theme-layout">
        ...
        <div class="topbar stick">
            <div class="logo">
                <a title="" href="{{url('post/index')}}">WorkJob</a>
            </div>
            ...
            <div class="top-area">
                ...
                <div class="user-img">
                    <img src="{{Storage::url(Auth::user()->user_picture)}}" width="50px" height="50px" alt="user_picture">
                </div>
                            ...
                            <div class="row" id="page-contents">
                                <div class="col-lg-3">
                                    <aside class="sidebar static">
                                        <div class="widget">
                                            <h4 class="widget-title">Options</h4>
                                            <ul class="naves">
                                                <li>
                                                    <i class="ti-clipboard"></i>
                                                    <a href="{{url('post/index')}}" title="">Post feed</a>
                                                </li>
                                                <li>
                                                    <i class="ti-files"></i>
                                                    <a href="{{url('user')}}" title="">My Profile</a>
                                                </li>
                                                <li>
                                                    <i class="ti-user"></i>
                                                    <a href="{{url('post/create')}}" title="">Create a Post</a>
                                                </li>
                                                <li>
                                                    <i class="ti-user"></i>
                                                    <a href="{{url('job/create')}}" title="">Create a Job</a>
                                                </li>
                                                <li>
                                                    <i class="ti-share"></i>
                                                    <a href="{{url('job/index')}}" title="">Job Announcements</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <form action="{{ route('logout') }}" method="post">
                                                        ...
                                                        <button type="submit" title="Logout" style="background-color: transparent; color:rgb(95, 95, 97); letter-spacing: 1px">Logout</button>
                                                    </form>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-lg-3">
                                    <aside class="sidebar static">
                                        <div class="widget">
                                            ...
                                            <div class="your-page">
                                                <figure>
                                                    <a href="#" title=""><img src="{{Storage::url(Auth::user()->user_picture)}}" alt="user_picture"></a>
                                                </figure>
                                                <div class="page-meta">
