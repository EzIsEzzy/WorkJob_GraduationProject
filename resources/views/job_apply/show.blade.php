...
<div class="central-meta item">
    <div class="user-post">
        ...
        <div class="coment-area d-flex flex-column justify-content-center text-center">
            <br>
            <a href="{{url('apply/accept/'.$info->id)}}" style="color:white; background-color:rgb(33, 145, 145); padding: 10px; border-radius: 5px">Approve</a> <br>
            <a style="color:white; background-color:rgb(145, 33, 33); padding: 10px; border-radius: 5px" href="{{url('apply/deny/'.$info->id)}}">Deny</a>
        </div>
    </div>
</div>
@endsection
